...
Two middleware functions are provided by default in the `gif-to-html-app.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `gif-to-html-app.handler` namespace to manage the enabled middleware.
